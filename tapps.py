...
parser.add_argument("action", help="Action to take", type=str, choices=["teach", "brew"])
parser.add_argument("-t", "--type", help="The type of tea to brew", type=str, choices=["chai", "white", "green", "oolong", "black", "rooibos", "herbal"], default="chai")
